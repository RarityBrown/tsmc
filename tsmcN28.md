...
```
xychart
    title "Ids - vgs (diode-connect)"
    x-axis "vgs(mV)" [0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540]
    y-axis "Ids(uA)" 0 --> 140
    line [0.00, 0.00, 0.01, 0.02, 0.04, 0.07, 0.13, 0.22, 0.39, 0.67, 1.12, 1.87, 3.03, 4.80, 7.40, 11.05, 15.93, 22.17, 29.79, 38.75, 48.97, 60.32, 72.68, 85.94, 100.00, 114.75, 130.13, 146.07, 162.49, 179.34, 196.57, 214.12, 231.95, 250.02, 268.30, 286.76]
```
